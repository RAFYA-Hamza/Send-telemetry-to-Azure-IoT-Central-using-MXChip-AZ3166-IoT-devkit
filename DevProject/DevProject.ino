...
String outputYellowState = "closed";
...
outputYellowState = "open";
digitalWrite(yellowLED, HIGH);
} else if (header.indexOf("GET /5/off") >= 0) {
Serial.println("Yellow LED is off");
outputYellowState = "closed";
digitalWrite(yellowLED, LOW);
}
...
// Web Page Heading
client.println("<body><h1>Temperature and Humidity monitoring</h1>");

// Display current state, and ON/OFF buttons for GPIO 2 Red LED 
client.println("<p>The heating is " + outputRedState + "</p>");
// If the outputRedState is off, it displays the OFF button 
if (outputRedState=="off") {
client.println("<p><a href=\"/2/on\"><button class=\"button buttonOff\">ON</button></a></p>");
} else {
client.println("<p><a href=\"/2/off\"><button class=\"button buttonRed\">OFF</button></a></p>");
} 

// Display current state, and ON/OFF buttons for GPIO 4 Green LED 
client.println("<p>The air conditioner is " + outputGreenState + "</p>");
// If the outputGreenState is off, it displays the OFF button 
if (outputGreenState =="off") {
client.println("<p><a href=\"/4/on\"><button class=\"button buttonOff\">ON</button></a></p>");
} else {
client.println("<p><a href=\"/4/off\"><button class=\"button buttonGreen\">OFF</button></a></p>");
}
client.println("</body></html>");

// Display current state, and ON/OFF buttons for GPIO 5 Yellow LED 
client.println("<p>The window is " + outputYellowState + "</p>");
// If the outputYellowState is off, it displays the OFF button 
  if (outputYellowState =="closed") {
client.println("<p><a href=\"/5/on\"><button class=\"button buttonOff\">OPEN</button></a></p>");
} else {
client.println("<p><a href=\"/5/off\"><button class=\"button buttonYellow\">CLOSED</button></a></p>");
}
client.println("</body></html>");
